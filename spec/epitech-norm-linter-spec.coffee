...
describe "EpitechNormLinter", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('epitech-norm-linter')

  describe "when the epitech-norm-linter:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'epitech-norm-linter:toggle'
        expect(epitechNormLinterPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'epitech-norm-linter:toggle'
        expect(epitechNormLinterElement).not.toBeVisible()
